    ...
    class userDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                String sql = "SELECT * FROM tb1_usersss";
        ...
        public bool Insert(userBLL u)
        {
            ...
            try
            {
                ...
                String sql = "INSERT INTO tb1_usersss(username, emailid, password, fullname, contact) VALUES (@username, @emailid, @password, @fullname, @contact)";
        ...
        public bool Update(userBLL u)
        {
            ...
            try
            {
                ...
                string sql = "UPDATE tb1_usersss SET username=@username, emailid=@emailid, password=@password, fullname=@fullname, contact=@contact WHERE userid=@userid";
        ...
        public bool Delete(userBLL u)
        {
            ...
            try
            {
                ...
                String sql = "DELETE FROM tb1_usersss WHERE userid=@userid";
        ...
        public DataTable Search(string keywords)
        {
            ...
            try
            {
                ...
                String sql = "SELECT * FROM tb1_usersss WHERE userid LIKE '%" + keywords + "%' OR fullname LIKE '%" + keywords + "%'";
        ...
        public userBLL GetIDFromUsername(string username)
        {
            ...
            try
            {
                ...
                string sql = "SELECT userid FROM tb1_usersss WHERE username='" + username + "'";
